...
//Возвращает текущее состояние маски установленных событий для задачи
...
void WaitEvent(TEventMask mask)
{
    ...
    printf("End of WaitEvent %i to task %s\n", mask, TaskQueue[RunningTask].name);
}
